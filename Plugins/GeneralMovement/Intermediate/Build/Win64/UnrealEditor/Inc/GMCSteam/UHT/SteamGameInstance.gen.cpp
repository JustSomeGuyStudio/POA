...
#include "GameInstance/SteamGameInstance.h"
...
template<> GMCSTEAM_API UScriptStruct* StaticStruct<FServerInfo>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamGameInstance_GetCurrentMapName_Statics::Function_MetaDataParams[] = {
		{ "Category", "Session" },
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_UserDesiredSessionName_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamGameInstance_HostGameSession_Statics::Function_MetaDataParams[] = {
		{ "Category", "Session" },
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamGameInstance_JoinGameSession_Statics::Function_MetaDataParams[] = {
		{ "Category", "Session" },
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_USteamGameInstance_OnNetworkFailure_Statics::NewProp_FailureType = { "FailureType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamGameInstance_eventOnNetworkFailure_Parms, FailureType), Z_Construct_UEnum_NetCore_ENetworkFailure, METADATA_PARAMS(0, nullptr) }; // 1012473499
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamGameInstance_OnNetworkFailure_Statics::NewProp_ErrorString_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USteamGameInstance_OnNetworkFailure_Statics::NewProp_ErrorString = { "ErrorString", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamGameInstance_eventOnNetworkFailure_Parms, ErrorString), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USteamGameInstance_OnNetworkFailure_Statics::NewProp_ErrorString_MetaData), Z_Construct_UFunction_USteamGameInstance_OnNetworkFailure_Statics::NewProp_ErrorString_MetaData) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamGameInstance_OnNetworkFailure_Statics::Function_MetaDataParams[] = {
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_USteamGameInstance_OnTravelFailure_Statics::NewProp_FailureType = { "FailureType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamGameInstance_eventOnTravelFailure_Parms, FailureType), Z_Construct_UEnum_Engine_ETravelFailure, METADATA_PARAMS(0, nullptr) }; // 726959650
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamGameInstance_OnTravelFailure_Statics::NewProp_ErrorString_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USteamGameInstance_OnTravelFailure_Statics::NewProp_ErrorString = { "ErrorString", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamGameInstance_eventOnTravelFailure_Parms, ErrorString), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USteamGameInstance_OnTravelFailure_Statics::NewProp_ErrorString_MetaData), Z_Construct_UFunction_USteamGameInstance_OnTravelFailure_Statics::NewProp_ErrorString_MetaData) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamGameInstance_OnTravelFailure_Statics::Function_MetaDataParams[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamGameInstance_RefreshServerList_Statics::Function_MetaDataParams[] = {
		{ "Category", "Session" },
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_MaxPublicConnections_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ServerListEntry_MetaData[];
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USteamGameInstance_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamGameInstance_GetCurrentMapName, "GetCurrentMapName" }, // 973016364
		{ &Z_Construct_UFunction_USteamGameInstance_HostGameSession, "HostGameSession" }, // 715906584
		{ &Z_Construct_UFunction_USteamGameInstance_JoinGameSession, "JoinGameSession" }, // 1084303541
		{ &Z_Construct_UFunction_USteamGameInstance_OnNetworkFailure, "OnNetworkFailure" }, // 4013586174
		{ &Z_Construct_UFunction_USteamGameInstance_OnTravelFailure, "OnTravelFailure" }, // 712017805
		{ &Z_Construct_UFunction_USteamGameInstance_RefreshServerList, "RefreshServerList" }, // 2639521572
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USteamGameInstance_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USteamGameInstance_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USteamGameInstance_Statics::NewProp_HostURL_MetaData[] = {
		{ "Category", "Session" },
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_USteamGameInstance_Statics::NewProp_HostURL = { "HostURL", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamGameInstance, HostURL), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USteamGameInstance_Statics::NewProp_HostURL_MetaData), Z_Construct_UClass_USteamGameInstance_Statics::NewProp_HostURL_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USteamGameInstance_Statics::NewProp_MaxPublicConnections_MetaData[] = {
		{ "Category", "Session" },
		{ "ClampMin", "0" },
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_USteamGameInstance_Statics::NewProp_MaxPublicConnections = { "MaxPublicConnections", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamGameInstance, MaxPublicConnections), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USteamGameInstance_Statics::NewProp_MaxPublicConnections_MetaData), Z_Construct_UClass_USteamGameInstance_Statics::NewProp_MaxPublicConnections_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USteamGameInstance_Statics::NewProp_MainMenu_MetaData[] = {
		{ "Category", "UI" },
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_USteamGameInstance_Statics::NewProp_PauseMenu = { "PauseMenu", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamGameInstance, PauseMenu), Z_Construct_UClass_UClass, Z_Construct_UClass_UPauseMenu_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USteamGameInstance_Statics::NewProp_PauseMenu_MetaData), Z_Construct_UClass_USteamGameInstance_Statics::NewProp_PauseMenu_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USteamGameInstance_Statics::NewProp_ServerListEntry_MetaData[] = {
		{ "Category", "UI" },
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_USteamGameInstance_Statics::NewProp_ServerListEntry = { "ServerListEntry", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamGameInstance, ServerListEntry), Z_Construct_UClass_UClass, Z_Construct_UClass_UServerListEntry_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USteamGameInstance_Statics::NewProp_ServerListEntry_MetaData), Z_Construct_UClass_USteamGameInstance_Statics::NewProp_ServerListEntry_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USteamGameInstance_Statics::NewProp_ServerList_Inner = { "ServerList", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FServerInfo, METADATA_PARAMS(0, nullptr) }; // 278723083
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USteamGameInstance_Statics::NewProp_ServerList_MetaData[] = {
		{ "Category", "Session" },
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USteamGameInstance_Statics::NewProp_ServerList = { "ServerList", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamGameInstance, ServerList), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USteamGameInstance_Statics::NewProp_ServerList_MetaData), Z_Construct_UClass_USteamGameInstance_Statics::NewProp_ServerList_MetaData) }; // 278723083
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USteamGameInstance_Statics::NewProp_UserDesiredSessionName_MetaData[] = {
		{ "Category", "Session" },
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_USteamGameInstance_Statics::StaticCppClassTypeInfo = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCSteam_Public_GameInstance_SteamGameInstance_h_Statics::ScriptStructInfo[] = {
		{ FServerInfo::StaticStruct, Z_Construct_UScriptStruct_FServerInfo_Statics::NewStructOps, TEXT("ServerInfo"), &Z_Registration_Info_UScriptStruct_ServerInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FServerInfo), 278723083U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCSteam_Public_GameInstance_SteamGameInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USteamGameInstance, USteamGameInstance::StaticClass, TEXT("USteamGameInstance"), &Z_Registration_Info_UClass_USteamGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamGameInstance), 652251889U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCSteam_Public_GameInstance_SteamGameInstance_h_1699344451(TEXT("/Script/GMCSteam"),
