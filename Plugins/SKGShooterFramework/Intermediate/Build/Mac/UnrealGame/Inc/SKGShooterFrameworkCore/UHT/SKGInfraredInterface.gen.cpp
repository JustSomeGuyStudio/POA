...
#include "SKGShooterFrameworkCore/Public/Interfaces/SKGInfraredInterface.h"
...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USKGInfraredInterface_Statics::Class_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Interfaces/SKGInfraredInterface.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_USKGInfraredInterface_Statics::StaticCppClassTypeInfo = {
	...
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SKGShooterFramework_Source_SKGShooterFrameworkCore_Public_Interfaces_SKGInfraredInterface_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SKGShooterFramework_Source_SKGShooterFrameworkCore_Public_Interfaces_SKGInfraredInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USKGInfraredInterface, USKGInfraredInterface::StaticClass, TEXT("USKGInfraredInterface"), &Z_Registration_Info_UClass_USKGInfraredInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USKGInfraredInterface), 2504433039U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SKGShooterFramework_Source_SKGShooterFrameworkCore_Public_Interfaces_SKGInfraredInterface_h_699033631(TEXT("/Script/SKGShooterFrameworkCore"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SKGShooterFramework_Source_SKGShooterFrameworkCore_Public_Interfaces_SKGInfraredInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SKGShooterFramework_Source_SKGShooterFrameworkCore_Public_Interfaces_SKGInfraredInterface_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
