...
struct FSKGRecoilSettings
{
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "SKGProcedural", meta = (EditCondition = "RecoilControlRotationCurve != nullptr"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "SKGProcedural", meta = (EditCondition = "RecoilLocationCurve != nullptr"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "SKGProcedural", meta = (EditCondition = "RecoilRotationCurve != nullptr"))
