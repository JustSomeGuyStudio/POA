...
#include "Subsystems/SKGShooterWorldSubsystem.h"
...
void USKGShooterWorldSubsystem::SetInfraredMaterialParameterCollection(UObject* WorldContextObject, UMaterialParameterCollection* MPC)
{
	if (WorldContextObject && WorldContextObject->GetWorld() && MPC)
	{
		InfraredMPC = WorldContextObject->GetWorld()->GetParameterCollectionInstance(MPC);
	}
}

void USKGShooterWorldSubsystem::SetNightVisionColor(const FLinearColor& Color)
{
	if (InfraredMPC)
	{
...
void USKGShooterWorldSubsystem::EnableInfraredMode()
{
...
void USKGShooterWorldSubsystem::DisableInfraredMode()
{
	if (bInfraredModeEnabled)
	{
		if (InfraredMPC)
...
void USKGShooterWorldSubsystem::RegisterInfraredDevice(UActorComponent* InfraredDevice)
{
...
void USKGShooterWorldSubsystem::UnregisterInfraredDevice(UActorComponent* InfraredDevice)
{
	if (InfraredDevice)
	{
