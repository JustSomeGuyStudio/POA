...
struct FSKGLaserSettings
{
	...
	// Scale factor for the laser dot to control how it scales up/down based on distance away
	UPROPERTY(EditDefaultsOnly, Category = "SKGLightLaser")
	float LaserDecalScaleFactor {500.0f};
	// Minimum size of the laser dot decal
	UPROPERTY(EditDefaultsOnly, Category = "SKGLightLaser")
	float MinLaserDecalSize {0.8f};
	// Maximum size of the laser decal
	UPROPERTY(EditDefaultsOnly, Category = "SKGLightLaser")
	float MaxLaserDecalSize {20.0f};
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SKGLightLaser|Laser")
	bool IsLaserOn() const { return LaserState.LaserMode == ESKGLaserMode::Off ? false : true; }
	...
	UFUNCTION(BlueprintPure, Category = "SKGLightLaser|Light")
	bool IsLightOn() const { return LightState.LightMode == ESKGLightMode::Off ? false : true; }
