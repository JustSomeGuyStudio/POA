...
protected:
	...
	bool bIsRequiredToFuntion {false};
	...
	FName AttachmentMeshName {"StaticMesh"};
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SKGAttachment|Attachment|Settings|Offset")
	...
	UFUNCTION(BlueprintCallable, Category = "SKGAttachment|Attachment|Preview")
	...
	UFUNCTION(BlueprintGetter)
	FORCEINLINE bool GetIsRequiredToFunction() const { return bIsRequiredToFuntion; }
};
