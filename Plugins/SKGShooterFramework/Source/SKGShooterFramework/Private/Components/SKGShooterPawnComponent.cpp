...
void USKGShooterPawnComponent::BeginPlay()
{
	...
	{
		GetWorld()->GetSubsystem<USKGShooterWorldSubsystem>()->SetInfraredMaterialParameterCollection(this, NightVisionMaterialParameterCollection);
	}
...
void USKGShooterPawnComponent::EnableInfraredMode()
{
	GetWorld()->GetSubsystem<USKGShooterWorldSubsystem>()->EnableInfraredMode();
}

void USKGShooterPawnComponent::DisableInfraredMode()
{
	GetWorld()->GetSubsystem<USKGShooterWorldSubsystem>()->DisableInfraredMode();
}
