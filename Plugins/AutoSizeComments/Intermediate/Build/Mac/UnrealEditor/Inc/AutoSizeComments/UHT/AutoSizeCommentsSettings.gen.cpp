...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_AutoSizeComments_EASCCacheSaveMethod_Statics::Enumerators[] = {
		{ "EASCCacheSaveMethod::File", (int64)EASCCacheSaveMethod::File },
		{ "EASCCacheSaveMethod::MetaData", (int64)EASCCacheSaveMethod::MetaData },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_AutoSizeComments_EASCCacheSaveMethod_Statics::Enum_MetaDataParams[] = {
...
template<> AUTOSIZECOMMENTS_API UScriptStruct* StaticStruct<FPresetCommentStyle>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPresetCommentStyle_Statics::NewProp_FontSize = { "FontSize", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPresetCommentStyle, FontSize), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPresetCommentStyle_Statics::NewProp_FontSize_MetaData), Z_Construct_UScriptStruct_FPresetCommentStyle_Statics::NewProp_FontSize_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPresetCommentStyle_Statics::NewProp_bSetHeader = { "bSetHeader", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FPresetCommentStyle), &Z_Construct_UScriptStruct_FPresetCommentStyle_Statics::NewProp_bSetHeader_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPresetCommentStyle_Statics::NewProp_bSetHeader_MetaData), Z_Construct_UScriptStruct_FPresetCommentStyle_Statics::NewProp_bSetHeader_MetaData) };
...
template<> AUTOSIZECOMMENTS_API UScriptStruct* StaticStruct<FASCGraphSettings>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FASCGraphSettings_Statics::NewProp_ResizingMode = { "ResizingMode", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FASCGraphSettings, ResizingMode), Z_Construct_UEnum_AutoSizeComments_EASCResizingMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FASCGraphSettings_Statics::NewProp_ResizingMode_MetaData), Z_Construct_UScriptStruct_FASCGraphSettings_Statics::NewProp_ResizingMode_MetaData) }; // 3529419041
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_HeaderColorMethod_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bUseMinimalTitlebarStyle_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bAutoRenameNewComments_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_CacheSaveMethod_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bPrettyPrintCommentCacheJSON_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bUseMaxDetailNodes_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ResizeCornerAnchorSize_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_ResizeCornerAnchorSize;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ResizeSidePadding_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bDisableASCGraphNode_MetaData[];
#endif
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_DefaultFontSize = { "DefaultFontSize", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, DefaultFontSize), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_DefaultFontSize_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_DefaultFontSize_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_HeaderColorMethod_MetaData[] = {
		{ "Category", "Color" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseRandomColorFromList = { "bUseRandomColorFromList", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseRandomColorFromList_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseRandomColorFromList_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseRandomColorFromList_MetaData) };
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_MinimumControlOpacity = { "MinimumControlOpacity", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, MinimumControlOpacity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_MinimumControlOpacity_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_MinimumControlOpacity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_TaggedPresets = { "TaggedPresets", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, TaggedPresets), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_TaggedPresets_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_TaggedPresets_MetaData) }; // 1912568889
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseMinimalTitlebarStyle_MetaData[] = {
		{ "Category", "UI" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseMinimalTitlebarStyle = { "bUseMinimalTitlebarStyle", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseMinimalTitlebarStyle_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseMinimalTitlebarStyle_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseMinimalTitlebarStyle_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDefaultColorCommentBubble = { "bDefaultColorCommentBubble", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDefaultColorCommentBubble_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDefaultColorCommentBubble_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDefaultColorCommentBubble_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDefaultShowBubbleWhenZoomed = { "bDefaultShowBubbleWhenZoomed", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDefaultShowBubbleWhenZoomed_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDefaultShowBubbleWhenZoomed_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDefaultShowBubbleWhenZoomed_MetaData) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_CommentTextPadding = { "CommentTextPadding", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, CommentTextPadding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_CommentTextPadding_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_CommentTextPadding_MetaData) }; // 2235102396
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_MinimumVerticalPadding = { "MinimumVerticalPadding", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, MinimumVerticalPadding), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_MinimumVerticalPadding_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_MinimumVerticalPadding_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseCommentBubbleBounds = { "bUseCommentBubbleBounds", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseCommentBubbleBounds_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseCommentBubbleBounds_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseCommentBubbleBounds_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bMoveEmptyCommentBoxes = { "bMoveEmptyCommentBoxes", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bMoveEmptyCommentBoxes_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bMoveEmptyCommentBoxes_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bMoveEmptyCommentBoxes_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_EmptyCommentBoxSpeed = { "EmptyCommentBoxSpeed", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, EmptyCommentBoxSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_EmptyCommentBoxSpeed_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_EmptyCommentBoxSpeed_MetaData) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_CacheSaveMethod_MetaData[] = {
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSaveCommentDataOnSavingGraph = { "bSaveCommentDataOnSavingGraph", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSaveCommentDataOnSavingGraph_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSaveCommentDataOnSavingGraph_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSaveCommentDataOnSavingGraph_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSaveCommentDataOnExit = { "bSaveCommentDataOnExit", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSaveCommentDataOnExit_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSaveCommentDataOnExit_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSaveCommentDataOnExit_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bPrettyPrintCommentCacheJSON_MetaData[] = {
		{ "Category", "CommentCache" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bPrettyPrintCommentCacheJSON = { "bPrettyPrintCommentCacheJSON", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bPrettyPrintCommentCacheJSON_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bPrettyPrintCommentCacheJSON_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bPrettyPrintCommentCacheJSON_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDetectNodesContainedForNewComments = { "bDetectNodesContainedForNewComments", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDetectNodesContainedForNewComments_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDetectNodesContainedForNewComments_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDetectNodesContainedForNewComments_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_ResizeChord = { "ResizeChord", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, ResizeChord), Z_Construct_UScriptStruct_FInputChord, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_ResizeChord_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_ResizeChord_MetaData) }; // 3669273635
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_EnableCommentControlsKey = { "EnableCommentControlsKey", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, EnableCommentControlsKey), Z_Construct_UScriptStruct_FInputChord, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_EnableCommentControlsKey_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_EnableCommentControlsKey_MetaData) }; // 3669273635
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_ResizeCollisionMethod = { "ResizeCollisionMethod", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, ResizeCollisionMethod), Z_Construct_UEnum_AutoSizeComments_ECommentCollisionMethod, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_ResizeCollisionMethod_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_ResizeCollisionMethod_MetaData) }; // 1928181872
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_AltCollisionMethod = { "AltCollisionMethod", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, AltCollisionMethod), Z_Construct_UEnum_AutoSizeComments_ECommentCollisionMethod, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_AltCollisionMethod_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_AltCollisionMethod_MetaData) }; // 1928181872
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSnapToGridWhileResizing = { "bSnapToGridWhileResizing", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSnapToGridWhileResizing_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSnapToGridWhileResizing_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSnapToGridWhileResizing_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodes = { "bIgnoreKnotNodes", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodes_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodes_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodes_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodesWhenPressingAlt = { "bIgnoreKnotNodesWhenPressingAlt", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodesWhenPressingAlt_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodesWhenPressingAlt_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodesWhenPressingAlt_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodesWhenResizing = { "bIgnoreKnotNodesWhenResizing", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodesWhenResizing_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodesWhenResizing_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreKnotNodesWhenResizing_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreSelectedNodesOnCreation = { "bIgnoreSelectedNodesOnCreation", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreSelectedNodesOnCreation_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreSelectedNodesOnCreation_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bIgnoreSelectedNodesOnCreation_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseMaxDetailNodes = { "bUseMaxDetailNodes", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseMaxDetailNodes_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseMaxDetailNodes_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bUseMaxDetailNodes_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_IgnoredGraphs = { "IgnoredGraphs", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAutoSizeCommentsSettings, IgnoredGraphs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_IgnoredGraphs_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_IgnoredGraphs_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_GraphSettingsOverride_ValueProp = { "GraphSettingsOverride", nullptr, (EPropertyFlags)0x0000000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FASCGraphSettings, METADATA_PARAMS(0, nullptr) }; // 2425206850
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSuppressSuggestedSettings = { "bSuppressSuggestedSettings", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSuppressSuggestedSettings_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSuppressSuggestedSettings_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSuppressSuggestedSettings_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSuppressSourceControlNotification = { "bSuppressSourceControlNotification", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSuppressSourceControlNotification_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSuppressSourceControlNotification_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bSuppressSourceControlNotification_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_ResizeCornerAnchorSize_MetaData[] = {
		{ "Category", "Controls" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bHideHeaderButton = { "bHideHeaderButton", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bHideHeaderButton_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bHideHeaderButton_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bHideHeaderButton_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bHideRandomizeButton = { "bHideRandomizeButton", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bHideRandomizeButton_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bHideRandomizeButton_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bHideRandomizeButton_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDebugGraph_ASC = { "bDebugGraph_ASC", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDebugGraph_ASC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDebugGraph_ASC_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDebugGraph_ASC_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDisablePackageCleanup = { "bDisablePackageCleanup", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDisablePackageCleanup_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDisablePackageCleanup_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDisablePackageCleanup_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDisableASCGraphNode_MetaData[] = {
		{ "Category", "Debug" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDisableASCGraphNode = { "bDisableASCGraphNode", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAutoSizeCommentsSettings), &Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDisableASCGraphNode_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDisableASCGraphNode_MetaData), Z_Construct_UClass_UAutoSizeCommentsSettings_Statics::NewProp_bDisableASCGraphNode_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AutoSizeComments_Source_AutoSizeComments_Public_AutoSizeCommentsSettings_h_Statics::EnumInfo[] = {
		{ EASCCacheSaveMethod_StaticEnum, TEXT("EASCCacheSaveMethod"), &Z_Registration_Info_UEnum_EASCCacheSaveMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2760348162U) },
		{ EASCCacheSaveLocation_StaticEnum, TEXT("EASCCacheSaveLocation"), &Z_Registration_Info_UEnum_EASCCacheSaveLocation, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3597408885U) },
		{ EASCResizingMode_StaticEnum, TEXT("EASCResizingMode"), &Z_Registration_Info_UEnum_EASCResizingMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3529419041U) },
		{ ECommentCollisionMethod_StaticEnum, TEXT("ECommentCollisionMethod"), &Z_Registration_Info_UEnum_ECommentCollisionMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1928181872U) },
		{ EASCAutoInsertComment_StaticEnum, TEXT("EASCAutoInsertComment"), &Z_Registration_Info_UEnum_EASCAutoInsertComment, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4028303345U) },
		{ EASCDefaultCommentColorMethod_StaticEnum, TEXT("EASCDefaultCommentColorMethod"), &Z_Registration_Info_UEnum_EASCDefaultCommentColorMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3222267391U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AutoSizeComments_Source_AutoSizeComments_Public_AutoSizeCommentsSettings_h_Statics::ScriptStructInfo[] = {
		{ FPresetCommentStyle::StaticStruct, Z_Construct_UScriptStruct_FPresetCommentStyle_Statics::NewStructOps, TEXT("PresetCommentStyle"), &Z_Registration_Info_UScriptStruct_PresetCommentStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPresetCommentStyle), 1912568889U) },
		{ FASCGraphSettings::StaticStruct, Z_Construct_UScriptStruct_FASCGraphSettings_Statics::NewStructOps, TEXT("ASCGraphSettings"), &Z_Registration_Info_UScriptStruct_ASCGraphSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FASCGraphSettings), 2425206850U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AutoSizeComments_Source_AutoSizeComments_Public_AutoSizeCommentsSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAutoSizeCommentsSettings, UAutoSizeCommentsSettings::StaticClass, TEXT("UAutoSizeCommentsSettings"), &Z_Registration_Info_UClass_UAutoSizeCommentsSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAutoSizeCommentsSettings), 177074075U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AutoSizeComments_Source_AutoSizeComments_Public_AutoSizeCommentsSettings_h_590665166(TEXT("/Script/AutoSizeComments"),
